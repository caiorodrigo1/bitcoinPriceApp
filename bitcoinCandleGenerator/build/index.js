...
var Candle_1 = __importDefault(require("./models/Candle"));
...
var readMarketPrice = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1.default.get(process.env.PRICES_API)];
            case 1:
                result = _a.sent();
                data = result.data;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                loopTimes = Period_1.default.FIVE_MINUTES / Period_1.default.TEN_SECONDS;
                candle = new Candle_1.default('BTC');
                console.log('---------------------------------');
            ...
            case 7:
                ...
                candleJson = JSON.stringify(candleObj);
