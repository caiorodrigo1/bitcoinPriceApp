...
var CandleMessageChannel = /** @class */ (function () {
    ...
    CandleMessageChannel.prototype._createMessageChannel = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a._channel = _b.sent();
                        this._channel.assertQueue(process.env.QUEU_NAME);
                        return [3 /*break*/, 4];
                    case 3:
                        err_1 = _b.sent();
    ...
    CandleMessageChannel.prototype.consumeMessages = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._createMessageChannel()];
                    case 1:
                        _a.sent();
                        if (this._channel) {
